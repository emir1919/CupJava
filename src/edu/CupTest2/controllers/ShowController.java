...
import edu.cupcake.services.CommentServices;
import edu.cupcake.services.EnseigneServices;
import edu.cupcake.services.FavoryBrandServices;
import edu.cupcake.services.RatingServices;
...
public class ShowController implements Initializable {
    ...
    edu.cupcake.entities.Rating r = new edu.cupcake.entities.Rating();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (cupcake.Cupcake.user == null) {
            ...
            try {
                l = fs.GetFavoriById(cupcake.Cupcake.user.getId());
            } catch (SQLException ex) {
                Logger.getLogger(ShowController.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void affiche2() {
        for (int i = 0; i < l1.size(); i++) {
            ...
            cir22.setFill(new ImagePattern(new Image("http://" +l1.get(i).getLogo())));
            ...
            b51.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    try {
                        ...
                        pane52 = FXMLLoader.load(getClass().getResource("/edu/cupcake/gui/BrandFront.fxml"));
            ...
            try {
                file52 = new FileInputStream("//home//berrahal//NetBeansProjects//upcake//src//edu//cupcake//ressources//images//info-g.png");
    ...
    public void affiche1() {
        for (int i = 0; i < enseignes.size(); i++) {
            try {
                ...
                System.out.println(enseignes.get(i).getLogo());
                String btet="http://localhost/cupcake/uploads/" +enseignes.get(i).getLogo();
                cir2.setFill(new ImagePattern(new Image(btet)));
                ...
                bf.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        try {
                            fbb1 = fbs.getfavoryById(k1, cupcake.Cupcake.user.getId());
                        } catch (SQLException ex) {
                            Logger.getLogger(ShowController.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        if (fbb1 == null) {
                        ...
                        if (test == true) {
                            ...
                            fbb.setUser_id( cupcake.Cupcake.user.getId());
                            try {
                ...
                try {
                    file22 = new FileInputStream("src//edu//cupcake//ressources//images//fav.png");
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(ShowBrandController.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                b.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        try {
                            ...
                            pane = FXMLLoader.load(getClass().getResource("/edu/cupcake/gui/BrandFront.fxml"));
                ...
                try {
                    file2 = new FileInputStream("src//edu//cupcake//ressources//images//info-g.png");
                ...
                rate.ratingProperty().addListener(new ChangeListener<Number>() {
                    ...
                    public void changed(ObservableValue<? extends Number> observable,
                        ...
                        r.setNote(n);
                        r.setEnseigne_id(k);
                        r.setUser_id( cupcake.Cupcake.user.getId());
                        try {
                            rs.ajouterRating(r);
                        } catch (SQLException ex) {
                            Logger.getLogger(ShowController.class.getName()).log(Level.SEVERE, null, ex);
