...
public class ShowController implements Initializable {
    ...
    public void affiche2() {
        for (int i = 0; i < l1.size(); i++) {
            ...
            try {
                file20 = new FileInputStream("localhost/cupcake/uploads" + l1.get(i).getLogo());
    ...
    public void affiche1() {
        for (int i = 0; i < enseignes.size(); i++) {
            try {
                ...
                try {
                    file = new FileInputStream("http://localhost/cupcake/uploads/" + enseignes.get(i).getLogo());
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(ShowBrandController.class.getName()).log(Level.SEVERE, null, ex);
                }
                //img.setImage(new Image(file));
                ...
                bf.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        if (test == true) {
                            ...
                            fbb.setUser_id((int) (long) cupcake.Cupcake.user.getId());
                            try {
