...
public class BakeryOrdersController implements Initializable {
    ...
    private void AffecterLivraison(ActionEvent event) throws IOException {
        if (combousers.getSelectionModel().getSelectedItem()==null) {
            ...
            alert2.setContentText("Veillez vérifier la selection du livreur");
            alert2.setHeaderText(null);
            alert2.show();
        }
        else if (orderslist.getSelectionModel().getSelectedItem()==null) {
            Alert alert2 = new Alert(Alert.AlertType.WARNING);
            alert2.setTitle("Erreur");
            alert2.setContentText("Veillez selectionner une ligne de commande");
            alert2.setHeaderText(null);
            alert2.show();
        }
        else
