...
public class BakeryManagementController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ObservableList<Product> list = FXCollections.observableArrayList(service.getProductsByBrand(currentBrand));
    ...
    private void RefreshStock(){
        ...
        ObservableList<ObservableStock> list = FXCollections.observableArrayList(service.getObsStocks(currentBakery));
    ...
    private void addStock(ActionEvent event) {
        try{
                ...
                if(!res){
                    Stock stock = new Stock((int)sQuantitySlider.getValue(), product.getId(), currentBakery, 0);
                    StockService service = new StockService();
